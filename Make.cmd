g++ BattleTest.cpp Spell.cpp SpellList.cpp Bear.cpp Body.cpp BearList.cpp^
 FindBear.cpp Modifier.cpp BearBattle.cpp Player.cpp Feats.cpp RollDice.cpp^
...
g++ BearFite.cpp Spell.cpp SpellList.cpp Bear.cpp Body.cpp BearList.cpp FindBear.cpp^
